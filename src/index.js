...
// import CouponList from "./components/Mobile/Cart/Coupon/CouponList";
const CouponList = Loadable({
	loader: () => import("./components/Mobile/Cart/Coupon/CouponList"),
	loading: () => <Loading />,
});
...
const SafeUpiPayment = Loadable({
	loader: () => import("./components/Mobile/Checkout/SafeUpiPayment"),
	loading: () => <Loading />,
});
		...
		<BrowserRouter>
			<React.Fragment>
				...
				<Switch>
					...
					<Route
						path={"/payment/safe-upi/:order_id"}
						exact
						component={SafeUpiPayment}
					/>
					...
					<Route
						path={"/cart/coupons"}
						exact
						component={withTracker(CouponList)}
					/>
